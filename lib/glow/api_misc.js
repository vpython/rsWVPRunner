;(function () {
    ...
    */
    ...
    var poptions = {place:null, width:640, height:100, readonly:true, pos:"bottom", digits:6}
    ...
    function print(args) { // similar to Python print()
    	...
    	if (printarea === null) { // need to make a new printarea
            ...
            container.appendTo(poptions.place || $('body'))    // evaluate $('body') lazily so it works when glow loads in <head>
        ...
        // Notify embedding hosts (e.g. Trinket calculator mode) that listen for print
        // output via postMessage and display it outside the printarea textarea.
