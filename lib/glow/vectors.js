;(function () {
    ...
    function vec(x, y, z) {
        ...
        // Handle keyword args passed as a plain object (e.g. vec(x=3, y=2, z=4) compiled by RapydScript)
        if (y === undefined && z === undefined && x !== null && typeof x === 'object' && !(x instanceof vec) && 'x' in x) {
            y = x.y; z = x.z; x = x.x
        }
